...
Power is the probability of rejecting null given the null is not true. From this plot, it is clearly that the power will increase if the effect size increases.
...
ggplot(rej_avg_beta1, aes( x = beta1_n, y = estimate_avg_rej)) +
  ...
  scale_x_continuous(
    breaks = c(1, 2, 3,4,5,6))
```
The sample average of beta1 across tests for which the null is rejected is NOT approximately equal to the true value of β1. It is higher.
